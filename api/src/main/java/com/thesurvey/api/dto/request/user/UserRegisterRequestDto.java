...
public class UserRegisterRequestDto {
    ...
    @NotBlank
    @Size(max = 50)
    @Schema(name = "name", example = "test", description = "이름은 50자 이내여야 합니다.")
    private String name;
    ...
    @Schema(example = "01012341234", description = "휴대폰 번호는 016~019로 시작해야 하며, '-'(hyphen)이 없는 숫자로 7자 이상 8이하여야 합니다.")
